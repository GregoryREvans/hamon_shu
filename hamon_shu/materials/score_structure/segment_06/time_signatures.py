...
from hamon_shu.materials.timespans.segment_06.make_timespans import rhythm_timespan_list

offset_counter = abjad.OffsetCounter(rhythm_timespan_list)

counter_path = f"""{pathlib.Path(__file__).parent}/segment_06_offset_counter.pdf"""
