from hamon_shu.materials.dynamics import dynamic_handlers_III
...
dict = {
    "dynamic_handler_two": dynamic_handlers_III.dynamic_handler_two,
    "dynamic_handler_three": dynamic_handlers_III.dynamic_handler_three,
}
