...
padovan_1 = evans.Sequence.e_dovan_cycle(n=3, iters=30, first=3, second=5, modulus=7)
padovan_2 = evans.Sequence.e_dovan_cycle(n=2, iters=30, first=2, second=3, modulus=3)
padovan_3 = evans.Sequence.e_dovan_cycle(n=2, iters=30, first=1, second=1, modulus=5)
...
pitch_timespan_maker = TaleaTimespanMaker(
    playing_talea=rmakers.Talea(counts=([45]), denominator=8),
