...
padovan_1 = evans.Sequence.e_dovan_cycle(n=3, iters=30, first=3, second=5, modulus=5)
padovan_2 = evans.Sequence.e_dovan_cycle(n=2, iters=30, first=2, second=3, modulus=4)
...
# rhythm#
# #######
rhythm_target_timespan = abjad.Timespan(0, (31, 4))
...
# dynamic#
# ########
dynamic_target_timespan = abjad.Timespan(0, (31, 4))
...
# articulation#
# #############
articulation_target_timespan = abjad.Timespan(0, (31, 4))
