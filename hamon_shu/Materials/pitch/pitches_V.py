...
chord_1 = evans.reproportion_chord(base=4.75, chord=chord_1, round=evans.to_nearest_eighth_tone)
chord_2 = evans.reproportion_chord(base=4.75, chord=chord_2, round=evans.to_nearest_eighth_tone)
chord_3 = evans.reproportion_chord(base=4.75, chord=chord_3, round=evans.to_nearest_eighth_tone)
chord_4 = evans.reproportion_chord(base=4.75, chord=chord_4, round=evans.to_nearest_eighth_tone)
