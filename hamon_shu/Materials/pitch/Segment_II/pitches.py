...
chord_1 = evans.reproportion_chord(base=1.5, chord=chord_1, round=True)
chord_2 = evans.reproportion_chord(base=1.5, chord=chord_2, round=True)
chord_3 = evans.reproportion_chord(base=1.5, chord=chord_3, round=True)
chord_4 = evans.reproportion_chord(base=1.5, chord=chord_4, round=True)
