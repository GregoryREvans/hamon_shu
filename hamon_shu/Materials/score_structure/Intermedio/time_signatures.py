import abjad
import pathlib
from hamon_shu.Materials.timespans.Intermedio.make_timespans import rhythm_timespan_list

offset_counter = abjad.OffsetCounter(rhythm_timespan_list)

counter_path = f"""{pathlib.Path(__file__).parent}/intermedio_offset_counter.pdf"""
