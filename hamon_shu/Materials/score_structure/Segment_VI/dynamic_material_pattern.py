from hamon_shu.Materials.dynamics import dynamic_handlers_VI
...
dict = {
    "dynamic_handler_one": dynamic_handlers_VI.dynamic_handler_one,
    "dynamic_handler_two": dynamic_handlers_VI.dynamic_handler_two,
    "dynamic_handler_three": dynamic_handlers_VI.dynamic_handler_three,
}
