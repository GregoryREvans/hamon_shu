from hamon_shu.Materials.dynamics import dynamic_handlers_IV
...
dict = {
    "dynamic_handler_two": dynamic_handlers_IV.dynamic_handler_two,
    "dynamic_handler_three": dynamic_handlers_IV.dynamic_handler_three,
}
