import evans
from hamon_shu.Materials.pitch.Segment_III.pitch_handlers import *
...
dict = {
    ...
    "violin_1_pitch_handler_two": violin_1_pitch_handler_two,
    "violin_1_pitch_handler_three": violin_1_pitch_handler_three,
    "violin_1_pitch_handler_four": violin_1_pitch_handler_four,
    "violin_2_pitch_handler_one": violin_2_pitch_handler_one,
    "violin_2_pitch_handler_two": violin_2_pitch_handler_two,
    "violin_2_pitch_handler_three": violin_2_pitch_handler_three,
    "violin_2_pitch_handler_four": violin_2_pitch_handler_four,
    "viola_pitch_handler_one": viola_pitch_handler_one,
    "viola_pitch_handler_two": viola_pitch_handler_two,
    "viola_pitch_handler_three": viola_pitch_handler_three,
    "viola_pitch_handler_four": viola_pitch_handler_four,
    "cello_pitch_handler_one": cello_pitch_handler_one,
    "cello_pitch_handler_two": cello_pitch_handler_two,
    "cello_pitch_handler_three": cello_pitch_handler_three,
    "cello_pitch_handler_four": cello_pitch_handler_four,
}
