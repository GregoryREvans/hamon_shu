from hamon_shu.Materials.noteheads import notehead_handlers_V
...
dict = {
    "notehead_handler_one": notehead_handlers_V.notehead_handler_one,
    "notehead_handler_two": notehead_handlers_V.notehead_handler_two,
    "notehead_handler_three": notehead_handlers_V.notehead_handler_three,
}
