from hamon_shu.Materials.dynamics import dynamic_handlers_V
...
dict = {
    "dynamic_handler_two": dynamic_handlers_V.dynamic_handler_two,
    "dynamic_handler_three": dynamic_handlers_V.dynamic_handler_three,
}
