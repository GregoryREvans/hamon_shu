import abjad
import pathlib
from hamon_shu.Materials.timespans.Segment_V.make_timespans import rhythm_timespan_list

offset_counter = abjad.OffsetCounter(rhythm_timespan_list)

counter_path = f"""{pathlib.Path(__file__).parent}/Segment_V_offset_counter.pdf"""
