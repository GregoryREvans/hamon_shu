...
from hamon_shu.Materials.score_structure.Segment_VII.dynamic_material_pattern import (
...
Segment_VII_dynamic_timespans = evans.ConvertTimespans.convert_timespans(
    materials=dynamic_mat,
    ts_list=dynamic_timespan_list,
    bounds=bounds,
    segment_name="Segment_VII_dynamic_timespans",
    current_directory=pathlib.Path(__file__).parent,
    add_silence=False,
)
