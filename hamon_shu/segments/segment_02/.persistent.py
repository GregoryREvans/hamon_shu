    ...
    [
        ...
        (
            ...
            [
                ...
                StopHairpin(),
                StopTextSpan(command='\\stopTextSpanOne'),
                StartTextSpan(command='\\startTextSpanOne', concat_hspace_left=0.5, left_text=Markup(contents=['\\center-column { \\center-align \\vcenter \\upright \\fraction 1 2 }'], literal=True), right_padding=3, style='invisible-line', tweaks=TweakInterface(('_literal', None), ('staff_padding', 6))),
