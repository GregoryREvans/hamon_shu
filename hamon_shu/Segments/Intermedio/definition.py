...
from hamon_shu.Materials.timespans.Intermedio.convert_timespans import (
    intermedio_rhythm_timespans,
    intermedio_timespans,
)
from hamon_shu.Materials.score_structure.score_structure import score
from hamon_shu.Materials.score_structure.Intermedio.time_signatures import (
    time_signatures,
)
from hamon_shu.Materials.pitch.Intermedio.clef_handlers import clef_handlers
...
maker = evans.SegmentMaker(
    ...
    rhythm_timespans=intermedio_rhythm_timespans,
    handler_timespans=intermedio_timespans,
